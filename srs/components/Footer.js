...
const Meta = () => (
  <div className="b">
    <a href="/sitemap.xml" className="dib mr2 underline">
      Sitemap
    </a>
    <a href="/rss.xml" className="dib mr2 underline">
      RSS
    </a>
    <a href="/feed.json" className="dib mr2 underline">
      JSON Feed
    </a>
  </div>
);
...
const OpenSite = () => (
  <div className="mt3">
    This{" "}
    <a href="https://github.com/krimlabs/krimlabs.com" className="underline">
      open-source
    </a>{" "}
    site was built with{" "}
    <a
...
const Netlify = () => (
  <div className="mt1">
    ...
    <a href="https://netlify.com" className="underline">
      Netlify
    </a>
    .
  </div>
