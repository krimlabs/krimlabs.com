...
const WeLoveClojure = () => (
  <div className="lh-copy">
    <p>
      ...
      <span className="b">unorthodox development process</span>, and lack of
      types make it tough to pickup or recommend.
    </p>
    <p>
...
const WhoMadeThisCourseAnswer = () => (
  <>
    <p>
      ...
      <a href="https://status.im" className="underline">
        Status
      </a>
      , one of the
      <span className="b">
    ...
    <p>
      ...
      <a href="https://juxt.pro" className="underline">
        JUXT
      </a>
      , the company behind{" "}
      <a href="https://github.com/juxt" className="underline">
        Yada, Bidi and, Crux
      </a>{" "}
...
const WhoIsThisCourseFor = () => (
  <>
    <p>
      This course is designed for <span className="b">Senior Developers</span>{" "}
      who are well versed with another language and want to grow more in the
      realm of functional techniques with Clojure.
    </p>
    <p>
      It is also designed for <span className="b">Tech Leads</span> and{" "}
      <span className="b">Hiring Managers</span> who want to nurture Clojure
      talent inside their teams.
    </p>
  </>
);
...
const WhatCanYouExpectToGain = () => (
  <>
    ...
    <p>
      In the long run,{" "}
      <span className="b">Clojure helps you think in a scalable way</span>. The
      ideas from Clojure will seep into other parts of your professional life,
      and in extreme cases, in your personal life.
    </p>
  </>
);
...
const ModeOfDelivery = () => (
  <>
    <p>
      ...
      <span className="b">2h 27 minutes of video content, 41 text lessons</span>
      , and source code for each lesson.
    </p>
    <p>
      The delivery is managed by our partners at{" "}
      <a href="https://newline.co" className="underline">
        Newline
      </a>
    ...
    <p>
      ...
      their{" "}
      <a href="https://www.newline.co/tos" className="underline">
        terms of service
      </a>{" "}
      and{" "}
      <a href="https://www.newline.co/privacy" className="underline">
        privacy policy
      </a>
      .
    </p>
