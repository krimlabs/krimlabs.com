  ...
  return (
    <div className="mt3 mb5">
      <div className="ba br2 bw2 b--white flex pt0 pt1-m pt3-l pl2 pl3-ns">
        ...
        <div className="pa3 f4 f3-ns" style={{ flex: 3 }}>
          <div className="f5 mb2">
            If you liked this post and want to stay updated, you can follow
            Shivek Khurana on:
          </div>
          <div>
            <a className="underline" href="https://twitter.com/shivek_khurana">
              Twitter
            </a>
            ,{" "}
            <a className="underline" href="https://github.com/shivekkhurana">
              Github
            </a>{" "}
            or{" "}
            <a
              className="underline"
              href="https://airtable.com/shrvdZbevPVW8fhRP"
            >
              Mailing List
            </a>
          </div>
      ...
      <div className="mt2 f7 o-30">
        Plant image illustration designed by{" "}
        <a href="http://www.freepik.com">rawpixel.com at Freepik</a>
      </div>
    </div>
  );
};
      ...
      <article className="mt3 pb5" style={{ overflowWrap: "break-word" }}>
        ...
        <div className="center w-90 w-80-m w-50-l">
          <div className="f4">
            ...
            <Follow />
            <div>
              <div className="ttu f6 b mb3">Share this post</div>
              <Share title={title} url={`https://krimlabs.com/blog/${slug}`} />
            </div>
          </div>
